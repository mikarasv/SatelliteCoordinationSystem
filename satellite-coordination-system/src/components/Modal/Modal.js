  ...
  return ReactDOM.createPortal(
    <div className="overlay-style">
      <div className="modal">
        ...
        {(children.failures.length == 0 && <p> <span> Failure reason: </span> Never failed </p>) ||
          <div>
        ...
        <p> <span> Local date: </span> 
          ...
          + "/" + children.date_utc.substr(8, 2) + " - " + children.date_utc.substr(11, 5)} 
        </p>
        {(children.links.webcast==null && <p><span> Webcast: </span> No webcast available </p>) ||
          <p> <span> Webcast: </span>
            <a className="link-style" href={children.links.webcast} target="_blank">
              {children.links.webcast}
            </a>
          </p>
        }
        {(children.links.article==null && <p><span> Article: </span> No article available </p>) ||
        <p> <span> Article: </span>
          <a className="link-style" href={children.links.article} target="_blank">
            {children.links.article}
          </a>
        </p>}
        {(children.links.wikipedia==null && <p><span> Wikipedia: </span> No link available </p>) ||
        <p> <span> Wikipedia: </span>
          <a className="link-style" href={children.links.wikipedia} target="_blank">
            {children.links.wikipedia}
          </a>
        </p>}
        {(children.links.reddit.launch==null && <p><span> Reddit: </span> No link available </p>) ||
        <p> <span> Reddit: </span>
          <a className="link-style" href={children.links.reddit.launch} target="_blank">
            {children.links.reddit.launch}
          </a>
        </p>}
      </div>
    </div>,
